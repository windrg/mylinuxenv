...
if ! exists('g:mwPalettes')
	let g:mwPalettes = {
	\	'original': [
		\   { 'ctermbg':'White',        'ctermfg':'Red', 'guibg':'#FF7272', 'guifg':'Black' },
		\   { 'ctermbg':'Blue',       'ctermfg':'Black', 'guibg':'#9999FF', 'guifg':'Black' },
		\   { 'ctermbg':'DarkGreen',       'ctermfg':'White', 'guibg':'DarkGreen', 'guifg':'White' },
		\   { 'ctermbg':'DarkBlue',       'ctermfg':'Green', 'guibg':'DarkBlue', 'guifg':'Green' },
		\   { 'ctermbg':'208',       'ctermfg':'160', 'guibg':'#ff8700', 'guifg':'#d70000' },
		\   { 'ctermbg':'130',       'ctermfg':'15', 'guibg':'#af5f00', 'guifg':'White' },
		\   { 'ctermbg':'72',       'ctermfg':'0', 'guibg':'#5faf87', 'guifg':'Black' },
		\   { 'ctermbg':'DarkGrey',       'ctermfg':'14', 'guibg':'#585858', 'guifg':'#005f5f' },
		\   { 'ctermbg':'55',       'ctermfg':'196', 'guibg':'#5f00af', 'guifg':'#ff0000' },
		\   { 'ctermbg':'31',       'ctermfg':'231', 'guibg':'#0087af', 'guifg':'#ffffff' },
		\   { 'ctermbg':'52',       'ctermfg':'160', 'guibg':'#5f0000', 'guifg':'#d70000' },
		\   { 'ctermbg':'148',       'ctermfg':'160', 'guibg':'#afd700', 'guifg':'#d70000' },
		\   { 'ctermbg':'252',       'ctermfg':'236', 'guibg':'#d0d0d0', 'guifg':'#303030' },
		\   { 'ctermbg':'208',       'ctermfg':'22', 'guibg':'#ff8700', 'guifg':'#005f00' },
		\   { 'ctermbg':'70',       'ctermfg':'231', 'guibg':'#5faf00', 'guifg':'#ffffff' },
		\   { 'ctermbg':'240',       'ctermfg':'231', 'guibg':'#585858', 'guifg':'#ffffff' },
		\   { 'ctermbg':'24',    'ctermfg':'231', 'guibg':'#87d7ff', 'guifg':'White' },
		\   { 'ctermbg':'98',       'ctermfg':'231', 'guibg':'#875fd7', 'guifg':'#ffffff' },
		\   { 'ctermbg':'208',       'ctermfg':'88', 'guibg':'#ff8700', 'guifg':'#870000' },
		\   { 'ctermbg':'Cyan',       'ctermfg':'196', 'guibg':'#8CCBEA', 'guifg':'#ff0000' },
		\   { 'ctermbg':'231',       'ctermfg':'55', 'guibg':'#5f00af', 'guifg':'#d7d7ff' },
		\   { 'ctermbg':'Grey',    'ctermfg':'Black', 'guibg':'#FFB3FF', 'guifg':'Black' },
		\   { 'ctermbg':'117',    'ctermfg':'23', 'guibg':'#87d7ff', 'guifg':'#005f5f' },
		\   { 'ctermbg':'24',    'ctermfg':'117', 'guibg':'#87d7ff', 'guifg':'#005f87' },
		\   { 'ctermbg':'240',    'ctermfg':'208', 'guibg':'#ff8700', 'guifg':'#585858' },
		\   { 'ctermbg':'52',    'ctermfg':'208', 'guibg':'#5f0000', 'guifg':'#585858' },
		\   { 'ctermbg':'55',       'ctermfg':'231', 'guibg':'#5f00af', 'guifg':'#ffffff' },
		\   { 'ctermbg':'148',       'ctermfg':'22', 'guibg':'#afd700', 'guifg':'#005f00' },
		\   { 'ctermbg':'240',       'ctermfg':'148', 'guibg':'#585858', 'guifg':'#afd700' },
		\   { 'ctermbg':'24',    'ctermfg':'0', 'guibg':'#87d7ff', 'guifg':'Black' },
		\   { 'ctermbg':'231',       'ctermfg':'DarkGreen', 'guibg':'#ffffff', 'guifg':'DarkGreen'},
		\   { 'ctermbg':'98',       'ctermfg':'White', 'guibg':'#875fd7', 'guifg':'White' },
		\   { 'ctermbg':'208',       'ctermfg':'White', 'guibg':'#ff8700', 'guifg':'White' },
		\   { 'ctermbg':'Cyan',       'ctermfg':'Black', 'guibg':'#8CCBEA', 'guifg':'Black' },
		\   { 'ctermbg':'Green',      'ctermfg':'Black', 'guibg':'#A4E57E', 'guifg':'Black' },
		\   { 'ctermbg':'Yellow',     'ctermfg':'Black', 'guibg':'#FFDB72', 'guifg':'Black' },
		\   { 'ctermbg':'231',       'ctermfg':'31', 'guibg':'#ffffff', 'guifg':'#0087af'},
		\],
...
"cysh
map <F6> :<C-u>call mark#SearchCurrentMark(0)<CR>
map <F10> :<C-u>call mark#SearchCurrentMark(1)<CR>
