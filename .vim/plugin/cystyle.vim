...
augroup linuxsty
    ...
    autocmd FileType java  call s:JavaFormatting()
...
command! -nargs=0 KernelStyle call s:LinuxHighlighting()
nmap <leader>k :call s:LinuxHighlighting()<cr>
" vim: ts=4 et sw=4

function s:JavaFormatting()
    setlocal tabstop=4
