...
" revised by windrg on 04/27/2014

if exists("g:/loaded_logcatish")
    finish
endif
let g:loaded_logcatish = 1

augroup logcatish
	au BufRead,BufNewfile *.logcat setfiletype logcat

	autocmd FileType udi call s:LogcatHighlighting()
augroup END


function s:LogcatHighlighting()
	"Define colors
